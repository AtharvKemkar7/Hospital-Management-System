...
import com.healthcare.patient.dto.response.ErrorResponse;
...
/**
 * Reads {@code Authorization: Bearer ...}, validates the JWT, and
 * populates the {@link org.springframework.security.core.context.SecurityContext}
 * with a {@link PatientPrincipal}. The raw token is never logged.
 */
@Component
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            PatientPrincipal principal = new PatientPrincipal(parsed.userId(), parsed.role());
