...
/**
 * HS256 JWT verifier. Verifies only — this service does not issue tokens.
 * Must stay algorithm-compatible with {@code auth-service}.
 */
@Component
public class JwtTokenVerifier {
    ...
    public ParsedToken parseAndVerify(String token) {
        try {
            ...
            // Defense against algorithm confusion: refuse non-HS256 tokens.
